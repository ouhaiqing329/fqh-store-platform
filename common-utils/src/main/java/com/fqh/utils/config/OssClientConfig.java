...
public class OssClientConfig {
    ...
    public OSS getOssCLient(){
        ...
        String endpoint = "https://bucket10002.oss-cn-shenzhen.aliyuncs.com/";
        // 阿里云账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM用户进行API访问或日常运维，请登录RAM控制台创建RAM用户。
        String accessKeyId = "LTAI5tBk4nGkBMoFMtRv8itZ";
        String accessKeySecret = "jrbPm9i2N0jlo6Q09Wtgkh2iB8HA7J";

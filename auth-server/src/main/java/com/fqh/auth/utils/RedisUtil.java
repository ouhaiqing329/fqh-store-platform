...
public class RedisUtil {
     ...
     * @param value token
     */
    public static void setJwtTokenCache(String key, String value) {
        if (!StringUtils.hasText(key)) {
            throw new ServiceException("Redis error,key is null!");
        }
        redisTemplate.opsForValue().set(JWT_TOKEN_PREFIX + key, value, 2, TimeUnit.HOURS);
    }
     ...
     * @return {@link String}
     */
    public static String getJwtTokenCache(String key) {
        Object value = redisTemplate.opsForValue().get(JWT_TOKEN_PREFIX + key);
